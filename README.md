...
2.	Redirector Change to our [dataset LFW-a](http://vis-www.cs.umass.edu/lfw/index.html) instead of the existing one, and not download the matching dataset (LFW).
